...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-R3HG9GC\\RAVEN;Database=CarRentalSystemDB; User ID=sa; Password=1234567890; TrustServerCertificate=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CarProducer>(entity =>
            {
                entity.HasKey(e => e.ProducerId)
                    .HasName("PK__CarProdu__133696B2F763D4F0");
            ...
            modelBuilder.Entity<CarRental>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.CarId, e.PickupDate, e.ReturnDate })
                    .HasName("PK__CarRenta__E01D12254D01FE0F");
            ...
            modelBuilder.Entity<Review>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.CarId })
                    .HasName("PK__Review__522467F87B83B584");
            ...
            modelBuilder.Entity<StaffAccount>(entity =>
            {
                entity.HasKey(e => e.StaffId)
                    .HasName("PK__StaffAcc__96D4AAF7FC7E193A");
